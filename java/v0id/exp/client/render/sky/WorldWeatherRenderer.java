	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		for (int dx = -8; dx <= 8; ++dx)
		{
			for (int dz = -8; dz <= 8; ++dz)
			{
                ...
                int k3 = j3 >> 16 & 65535;
                int l3 = j3 & 65535;
				vb.pos(rOffX + x + 1 + dx - offset.xCoord, py + 16, rOffZ + z + dz + 0.5 - offset.zCoord).tex(offsetXTex, offsetYTex + 4).color(1, 1, 1, 0.5F).lightmap(k3, l3).endVertex();
				vb.pos(rOffX + x + dx - offset.xCoord, py + 16, rOffZ + z + dz + 0.5 - offset.zCoord).tex(offsetXTex + 0.5, offsetYTex + 4).color(1, 1, 1, 0.5F).lightmap(k3, l3).endVertex();
				...
				vb.pos(rOffX + x + 0.5 + dx - offset.xCoord, py + 16, rOffZ + z + dz + 1 - offset.zCoord).tex(offsetXTex, offsetYTex + 4).color(1, 1, 1, 0.5F).lightmap(k3, l3).endVertex();
				vb.pos(rOffX + x + 0.5 + dx - offset.xCoord, py + 16, rOffZ + z + dz - offset.zCoord).tex(offsetXTex + 0.5, offsetYTex + 4).color(1, 1, 1, 0.5F).lightmap(k3, l3).endVertex();
