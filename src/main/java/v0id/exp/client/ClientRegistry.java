...
public class ClientRegistry implements IInstanceProvider, ILifecycleListener
{
    ...
    public void preInit(FMLPreInitializationEvent evt)
    {
        ...
        ModelLoader.setCustomStateMapper(ExPBlocks.genericShrubbery, new StateMapperGenericShrubbery(ExPBlocks.genericShrubbery));
    ...
    class StateMapperGenericShrubbery extends StateMapperBase
    {
