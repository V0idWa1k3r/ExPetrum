...
public class WorldSkyRenderer extends IRenderHandler
{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) 
	{
        ...
        BufferBuilder.pos((double)(-f17), renderDistance * 1.5f, (double)(-f17)).tex(0.0D, 0.0D).endVertex();
        BufferBuilder.pos((double)f17, renderDistance * 1.5f, (double)(-f17)).tex(0.5D, 0.0D).endVertex();
        BufferBuilder.pos((double)f17, renderDistance * 1.5f, (double)f17).tex(0.5D, 0.5D).endVertex();
        BufferBuilder.pos((double)(-f17), renderDistance* 1.5f, (double)f17).tex(0.0D, 0.5D).endVertex();
        tessellator.draw();
        ...
        BufferBuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        BufferBuilder.pos((double)(-f17), -renderDistance * 1.5f, (double)f17).tex((double)f24, (double)f14).endVertex();
        BufferBuilder.pos((double)f17, -renderDistance * 1.5f, (double)f17).tex((double)f22, (double)f14).endVertex();
        BufferBuilder.pos((double)f17, -renderDistance * 1.5f, (double)(-f17)).tex((double)f22, (double)f23).endVertex();
        BufferBuilder.pos((double)(-f17), -renderDistance * 1.5f, (double)(-f17)).tex((double)f24, (double)f23).endVertex();
        tessellator.draw();
        GlStateManager.popMatrix();
