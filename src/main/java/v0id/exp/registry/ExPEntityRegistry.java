...
public class ExPEntityRegistry extends AbstractRegistry
{
	...
	public void registerEntities(RegistryEvent.Register<EntityEntry> event)
    {
        event.getRegistry().registerAll(
                ...
                EntityEntryBuilder.create().entity(EntityThrownSpear.class).name(ExPRegistryNames.entityThrownSpear.toString().replace(':', '.')).id(ExPRegistryNames.entityThrownSpear, 8).tracker(32, 1, true).build(),
