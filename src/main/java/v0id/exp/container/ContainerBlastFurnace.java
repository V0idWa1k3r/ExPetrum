...
public class ContainerBlastFurnace extends Container
{
    ...
    public ContainerBlastFurnace(InventoryPlayer playerInventory, TileBlastFurnace furnace)
    {
        this.tile = furnace;
        this.addSlotToContainer(new SlotItemHandler(furnace.inventory, 0, 134, 26));
        this.addSlotToContainer(new SlotItemHandler(furnace.inventory, 1, 134, 44));
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.listeners.size(); ++i)
        {
            ...
            if (this.maxBurnTime != this.tile.maxWork)
            {
                icontainerlistener.sendWindowProperty(this, 2, this.tile.maxWork);
            }
        }

        this.temperature = this.tile.temperatureHandler.getCurrentTemperature();
        this.burnTime = this.tile.work;
        this.maxBurnTime = this.tile.maxWork;
}
