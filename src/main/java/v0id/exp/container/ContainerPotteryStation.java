...
public class ContainerPotteryStation extends Container
{
    public ContainerPotteryStation(InventoryPlayer inventoryPlayer, TilePotteryStation potteryStation)
    {
