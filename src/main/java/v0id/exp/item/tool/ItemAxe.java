...
public class ItemAxe extends ItemExPTool implements IWeapon, IWeightProvider, IInitializableItem, IItemRegistryEntry, IOreDictEntry
{
	public ItemAxe()
	{
		super();
	...
	{
		this.setRegistryName(ExPRegistryNames.itemAxe);
