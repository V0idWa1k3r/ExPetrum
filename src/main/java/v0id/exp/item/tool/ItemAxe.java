...
public class ItemAxe extends ItemExPTool implements IWeapon, IWeightProvider, IOreDictEntry
{
	public ItemAxe(EnumToolStats stats)
	{
		super(stats, EnumToolClass.AXE);
        this.setSelfRegistryName(ExPRegistryNames.asLocation(ExPRegistryNames.itemAxe));
	...
	{
        Arrays.stream(EnumToolStats.values()).forEach(mat -> Arrays.stream(ExPOreDict.itemAxe).forEach(name ->
        {
