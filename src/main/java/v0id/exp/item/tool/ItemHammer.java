...
public class ItemHammer extends ItemExPTool implements IWeapon, IWeightProvider, IInitializableItem, IItemRegistryEntry, IOreDictEntry
{
	public ItemHammer()
	{
		super();
	...
	{
		this.setRegistryName(ExPRegistryNames.itemHammer);
