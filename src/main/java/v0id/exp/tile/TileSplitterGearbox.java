...
public class TileSplitterGearbox extends TileEntity implements ITickable, ISyncableTile
{
    ...
    {
        this.output0 = EnumFacing.values()[tag.getByte("out_0")];
        this.output1 = EnumFacing.values()[tag.getByte("out_1")];
    }
}
