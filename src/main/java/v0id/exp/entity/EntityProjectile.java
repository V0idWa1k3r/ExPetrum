...
public abstract class EntityProjectile extends Entity implements IProjectile
{
    ...
    public static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityArrow.class, DataSerializers.BYTE);
    public int xTile;
    public int yTile;
    public int zTile;
    public Block inTile;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            if (!this.world.isRemote && (block != this.inTile || j != this.inData) && !this.world.collidesWithAnyBlock(this.getEntityBoundingBox().grow(0.05D)))
            {
                this.inGround = false;
            ...
            else
            {
                ...
                if (!this.world.isRemote && this.ticksInGround % 20 == 0 && this.ticksInGround < 400)
                {
                    ExPNetwork.sendProjectileCollide(this);
                }
            }
    ...
    public abstract boolean causeImpactDamage(Entity entityHit);
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            if (this.causeImpactDamage(entity))
            {
