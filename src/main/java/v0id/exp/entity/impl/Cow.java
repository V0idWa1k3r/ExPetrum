...
public class Cow extends EntityAnimal
{
    ...
    public void handleElapsedTicks(long elapsed)
    {
        ...
        if (this.world.rand.nextFloat() < 0.003F && this.animalCapability.getAge() % 200 == 0 && this.animalCapability.getGender() == EnumGender.FEMALE && !this.animalCapability.isPregnant() && this.animalCapability.getFamiliarity() >= 10)
        {
