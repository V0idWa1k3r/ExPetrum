...
{
	/**
	 * World the coral is generated in
	 */
	public final World world;
	
	/**
	 * Position in the world the coral is generating at
	 */
	...
	/**
	 * Coral generator. Please do not set to null. 
	 * Can be changed to another WorldGenerator implementation.
	 * If changed the provided implementation will be used when generating coral.
	 */
	@Nonnull
