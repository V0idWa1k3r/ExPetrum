...
{
	STONE(null, 128, 1, 3, 0.8F, 2.0F, EnumPlayerProgression.STONE_AGE, 0),
	COPPER(EnumMetal.COPPER, 384, 2, 4, 0.8F, 4.0F, EnumPlayerProgression.CHALCOLITHIC, 1),
	BRONZE(EnumMetal.BRONZE, 768, 3, 5, 1F, 5.0F, EnumPlayerProgression.BRONZE_AGE, 2),
	BISMUTH_BRONZE(EnumMetal.BISMUTH_BRONZE, 844, 3, 5, 0.9F, 4.6F, EnumPlayerProgression.BRONZE_AGE, 2),
	LEADED_BRONZE(EnumMetal.HIGH_LEADED_BRONZE, 576, 3, 6, 1.0F, 4.8F, EnumPlayerProgression.BRONZE_AGE, 2),
	MANGANESE_BRONZE(EnumMetal.MANGANESE_BRONZE, 1340, 3, 3, 0.8F, 3.0F, EnumPlayerProgression.BRONZE_AGE, 2),
	ROSE_ALLOY(EnumMetal.ROSE_ALLOY, 684, 3, 5, 1.1F, 5.0F, EnumPlayerProgression.BRONZE_AGE, 2),
	IRON(EnumMetal.IRON, 1536, 5, 6, 1.0F, 6.0F, EnumPlayerProgression.IRON_AGE, 3),
